...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "Solar Sensor Input",
      NULL,
      "Selects how the solar sensor level is provided for games that included a solar sensor in their cartridges, e.g: the Boktai series. Note: For 'L3 + Stick Chords', set RetroArch's 'Analog to Digital Type' to 'None'.",
      NULL,
      "input",
      {
         { "off",    "Disabled" },
